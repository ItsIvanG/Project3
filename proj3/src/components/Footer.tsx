...
export function Footer() {
  return (
    <footer className='bg-primary text-secondary py-10 px-10 lg:px-24'>
      <div className=''>
        <div className='w-full flex flex-col lg:grid lg:grid-cols-4 gap-8 justify-center items-center text-center lg:justify-start lg:items-start lg:text-start'>
          ...
          <div className='lg:col-span-2 space-y-4'>
            ...
            <p className='text-secondary/75 lg:max-w-md text-sm xl:text-lg'>
          ...
          {FOOTER_COLUMNS.map((column) => (
            <div key={column.title}>
              <h3 className='font-semibold text-sm xl:text-lg lg:mb-4'>
                {column.title}
              </h3>
              <ul className='lg:space-y-3 text-base xl:text-lg'>
                {column.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className='text-sm xl:text-lg text-secondary/75 hover:text-secondary transition-colors'
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className='mt-12 pt-8 border-t border-secondary/40'>
          <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
            <p className='text-sm text-secondary/75 text-center md:text-start'>
