...
import { DashboardStats, StatsCard } from '@/lib/definitions';
  ...
  return (
    <div className='w-full bg-card shadow rounded-lg p-4 flex flex-row gap-4 items-center justify-between'>
      <div className='flex flex-row gap-4 items-center'>
        <div className='shadow border dark:border-primary/75 rounded-md flex justify-center items-center p-2 text-lg '>
