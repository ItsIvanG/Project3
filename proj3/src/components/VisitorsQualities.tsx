...
export function VisitorsQualities() {
  return (
    <div className='bg-secondary min-h-screen px-24 py-20 w-full justify-center items-center'>
      <div className='flex flex-row gap-10'>
        {/* Header Section */}
        <div className='space-y-10 w-[40%] justify-center items-start flex flex-col'>
